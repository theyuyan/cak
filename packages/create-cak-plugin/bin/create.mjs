#!/usr/bin/env node
// create-cak-plugin：npx create-cak-plugin <name> --contract <name> [--digest sha256:…] [--sdk <spec>]
...
const vars = { __NAME__: name, __CLASS__: cls, __CONTRACT__: flag('contract'), __DIGEST__: flag('digest') ?? 'sha256:REPLACE_ME_FROM_REGISTRY', __SDK__: flag('sdk') ?? 'github:theyuyan/cak#main' };
