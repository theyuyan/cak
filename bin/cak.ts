...
if (cmd !== 'run' || !specPath) { console.log('用法: cak run <spec.yaml> --input "…" [--workspace DIR] [--mock-script FILE] [--ledger FILE] [--verbose] [--auto-approve] [--allow-outside]'); process.exit(1); }
